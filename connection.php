<?php
	...
	//$con=mysqli_connect("localhost","root","","ainextgen_development") or die('Database connection issue'); // Server DB connection


	//$con = mysqli_connect("localhost","kundan","hello@9582","ainextgen_development") or die('Database connection issue');// Local DB connection
